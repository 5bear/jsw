...
public class FileUtil {
     ...
     * @return
     */
    public static String uploadFile(String realPath,MultipartFile file){
        ...
        String fileType=originName.substring(originName.indexOf(".")+1,originName.length());
        // 判断文件是否存在
        if (!file.isEmpty()) {
            if(!originName.contains("."))
                newFileName=originName;
            else
                newFileName=originName.substring(0, originName.indexOf("."));
            String path = realPath + "/" + newFileName+"."+fileType;
     ...
     * @return
     */
    public static String uploadFic(String realPath,MultipartFile file){
        File mainFile=new File(realPath);
        //文件保存目录URL
        String newFileName="";
        if(!mainFile.exists())
