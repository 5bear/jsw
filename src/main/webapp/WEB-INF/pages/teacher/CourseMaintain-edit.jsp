      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
          ...
          <table class="table vertical-table">
            ...
            <tr>
              <td>案例名称</td>
              <td><input type="text" id="title" class="table-input" name="title"/></td>
            </tr>
            <tr>
              <td>案例分类</td>
              <td>
            ...
            <tr>
              ...
              <td><input type="text" name="tTag" class="table-input"/></td>
            </tr>
            <tr>
              <td>案例描述</td>
              <td>
                <textarea name="description" placeholder="请输入50字到100字的案例描述，可以从国别地区，入库时间，教学时间，教学地点，课堂规模，教学手段，年龄层次，汉语水平，专业背景，家庭背景，宗教背景等方面进行叙述。" maxlength="100"></textarea>
              </td>
            </tr>
            <tr>
              <td>案例预览图</td>
              <td><input type="file" name="previewPic" accept="image/*" multiple onchange="preview(this)"/><div id="preview"></div></td>
            </tr>
            <tr>
              <td>上传案例</td>
