...
<div id="wrapper">
  ...
  <jsp:include page="../public/backNavi.jsp">
    <jsp:param name="pageName" value="PasswordManage"></jsp:param>
  </jsp:include>
    ...
    <div class="row password-row">
      <div class="col-lg-6 col-lg-offset-3">
        <table class="table vertical-table">
          ...
          <tr>
            <td>新密码</td>
            <td><input type="text" id="pwd" class="table-input"/></td>
          </tr>
          <tr>
            <td>请确认新密码</td>
            <td><input type="text" id="repwd" class="table-input"/></td>
          </tr>
          </tbody>
        </table>
...
<script>
  function changePwd(){
    ...
    $.ajax({
      url:"<%=request.getContextPath()%>/adminPasswordManage",
      type:"post",
      data:{newPwd:pwd},
